...
public class BeaconUtils
{
    ...
    public static Beacon beaconFromLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
		...
		return new Beacon(device.getName(), device.getAddress(), proximityUUID, major, minor, measuredPower, rssi);
    }
...
//   }
   ...
   public static String normalizeProximityUUID(String uuid) {
...
//	   double[] values = new KalmanFilter(accuracy, 0.05).filter();
//	   
//	   return values[0];
//		
//	}
